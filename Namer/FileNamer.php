...
class FileNamer implements NamerInterface
{
    ...
    {
        $uploadDir = implode(DIRECTORY_SEPARATOR, [$mapping->getUploadDestination(), $mapping->getUploadDir($object)]);
        ...
        $name = preg_replace(sprintf('/\.%s$/', $file->getClientOriginalExtension()), '', (string)$file->getClientOriginalName());
